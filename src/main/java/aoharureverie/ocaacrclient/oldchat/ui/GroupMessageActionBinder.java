...
public class GroupMessageActionBinder {
    public interface NameResolver {
        String resolve(String uid);
    }

    public interface RecallChecker {
        boolean canRecall(GroupMessage msg);
    }
    ...
    public static void bind(final Context context,
                            ...
                            final GroupMessageAdapter.GroupMessageActionListener actionListener,
        ...
        View.OnLongClickListener listener = new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                if (recallChecker != null && recallChecker.canRecall(msg)) {
                    menu.getMenu().add("撤回");
                }
                ...
                menu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(android.view.MenuItem item) {
                        ...
                        if ("复制".equals(title)) {
                            ...
                            String name = nameResolver == null ? null : nameResolver.resolve(msg.from_uid);
                            actionListener.onQuote(msg, name);
                        } else if ("举报".equals(title)) {
                            MessageReportHelper.reportGroupMessage(context, msg);
        ...
        if (avatar != null && !isMine) {
            final String name = nameResolver == null ? null : nameResolver.resolve(msg.from_uid);
            avatar.setOnLongClickListener(new View.OnLongClickListener() {
                @Override
                public boolean onLongClick(View v) {
                    actionListener.onMention(msg, name);
                    return true;
                }
            });
        } else if (avatar != null) {
    ...
    private static void saveEmojiFromMessage(final Context context, GroupMessage msg) {
    ...
    private static void saveMediaToDownloads(final Context context, GroupMessage msg, boolean isEmoji) {
        if (msg == null || msg.media_url == null || msg.media_url.length() == 0) {
            return;
        }
